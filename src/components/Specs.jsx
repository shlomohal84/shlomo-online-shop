    ...
    <Accordion>
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body style={{ textWrap: "wrap" }}>
          {product && product.description && product.description.cpu
      ...
      <Accordion.Item eventKey="1">
        ...
        <Accordion.Body style={{ textWrap: "wrap" }}>
          {product && product.description && product.description.gpu
            ? product.description.gpu
            : "TBA"}
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="2">
        ...
        <Accordion.Body style={{ textWrap: "wrap" }}>
          {product && product.description && product.description.ram
